...
def ddpg_objective_fix_params():
    ...
    number_past_vals = trial_config["number_past_vals"]  # trial.suggest_int("number_past_vals", 0, 15)
...
def ddpg_objective_fix_params_optuna(trial):
    ...
    safe_layer = trial.suggest_int("safe_layer", 0, 0)
